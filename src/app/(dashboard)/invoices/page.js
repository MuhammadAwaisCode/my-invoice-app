...
// Har currency ke mutabiq symbol aur layout handle karne ke liye dynamic function
function formatCurrency(amount, currencyCode) {
  if (amount === undefined || amount === null) return "—";
  
  // Agar invoice ke paas apni currency code ho (e.g. USD, AED, EUR)
  ...
  // Agar currency PKR ho ya na mili ho, toh aapka standard PKR format chalega
